...
var xml1_0StartRegex = ":A-Za-z_\\uC0-\\uD6\\uD8-\\uF6\\uF8-\\u2FF\\u370-\\u37D\\u37F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\u10000-\\uEFFFF\\u4a"
...
util.validate = function(element, type, value, mode) {
  mode = mode || 'fallback';
  if (util.regex[mode] && util.regex[mode][type]) {
    var filters = util.regex[mode].filters;
    var result = filters[type].test(value);
    if (!result) {
      // TODO: forward this to the proper channel
      return false;
    } else {
      return result;
    }
