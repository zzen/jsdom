...
// TODO: move something like this into document.
//require('../util').regex.invalidNamespace = /[^\u0009\u000A\u000D\u0020-\uD7FF\uE000-\uFFFD\u10000-\u10FFFF]/;
//require('../util').regex.tag              = /[^\u0009\u000A\u000D\u0020-\uD7FF\uE000-\uFFFD\u10000-\u10FFFF]/;
...
core.Attr.prototype.__defineGetter__('schemaTypeInfo', function() {
  if (!this._schemaTypeInfo) {
    this._schemaTypeInfo = new core.TypeInfo();
  }
...
core.TypeInfo = function() {
  this._typeName = 'CDATA';
  this._typeNamespace = 'http://www.w3.org/TR/REC-xml';
};
