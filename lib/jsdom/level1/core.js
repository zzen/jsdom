...
core.NodeList = function NodeList(element, query) {
  ...
  if (typeof query === 'function') {
    ...
    this._snapshot = query;
  }
};
core.NodeList.prototype = {
  update: function() {
    if (this._query && this._version < this._element._version) {
  ...
  indexOf: function(node) {
    ...
    return this._snapshot.indexOf(node);
  }
};
...
core.Node.prototype = {
  ...
  _indexOf: function(/*Node*/ child) {
    if (!this._childNodes || !this._childNodes.length) {
      return -1;
    }
  ...
  get nextSibling() {
    ...
    var index = this._parentNode._childNodes.indexOf(this);
  ...
  insertBefore :  function(/* Node */ newChild, /* Node*/ refChild){
    ...
    if (newChild.nodeType === DOCUMENT_FRAGMENT_NODE) {
      ...
      if (refChild == null) {
        ...
        var refChildIndex = this._childNodes.indexOf(refChild);
        if (refChildIndex == -1) {
  ...
  removeChild : function(/* Node */ oldChild){
    ...
    var oldChildIndex = this._childNodes.indexOf(oldChild);
    if (oldChildIndex == -1) {
      throw new core.DOMException(NOT_FOUND_ERR);
    }
