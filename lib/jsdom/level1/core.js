...
core.Element.prototype = {
  ...
  getElementsByTagName: function(/* string */ name) {
    ...
    return new core.NodeList(this._ownerDocument || this, util.mapper(this, filterByTagName, true));
  },
};
...
core.Document.prototype = {
  ...
  getElementsByTagName: function(/* string */ name) {
    ...
    return new core.NodeList(this.documentElement || this, util.mapper(this, filterByTagName, true));
  }
};
