...
function descendants(e, tagName, recursive) {
  ...
  return new core.HTMLCollection(owner, util.mapper(e, function(n) {
...
core.HTMLDocument.prototype = {
  ...
  get applets() {
    return new core.HTMLCollection(this, util.mapper(this, function(el) {
      if (el && el.tagName) {
...
define('HTMLFormElement', {
  ...
  proto: {
    get elements() {
      return new core.HTMLCollection(this._ownerDocument, util.mapper(this, function(e) {
...
define('HTMLSelectElement', {
  ...
  proto: {
    get options() {
      return new core.HTMLOptionsCollection(this, util.mapper(this, function(n) {
...
define('HTMLTableRowElement', {
  ...
  proto: {
    get cells() {
      if (!this._cells) {
        this._cells = new core.HTMLCollection(this, util.mapper(this, function(n) {
