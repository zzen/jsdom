...
var INVALID_STATE_ERR        = core.INVALID_STATE_ERR        = 11,
    ...
    util = require('../util'),
    ns = core.namespace = {
      validate : function(element, ns, URI) {
        if (!ns) {
        ...
        if(!util.validate(element, 'namespace', ns)) {
...
{
  var URI;
  if (qualifiedName === 'xml') {
    URI = 'http://www.w3.org/XML/1998/namespace';
  }

  ns.validate(this, qualifiedName, URI);
                                                           ...
                                                           /* DocumentType */ doctype)
{
  if (qualifiedName || namespaceURI) {
    ns.validate(this, qualifiedName, namespaceURI);
  }
...
core.Node.prototype.__defineSetter__("prefix", function(value) {
  ...
  ns.validate(this, value, this._namespaceURI);
...
core.Node.prototype.__defineSetter__("qualifiedName", function(qualifiedName) {
  ns.validate(this, qualifiedName, this._namespaceURI);
                                                         ...
                                                         /* String */ localName)
{
  ...
  return new core.NodeList(this.ownerDocument || this,
                           util.mapper(this, filterByTagName));
};
                                              ...
                                              /* bool */ deep)
{
  ...
  if (deep) {
    util.visitTree(newNode, lastChance);
  }
  else {
    lastChance(newNode);
  }
...
core.Element.prototype._idAttribute = 'id';

core.Element.prototype.__defineGetter__("id",function() {
  return this.getAttribute(this._idAttribute);
});
